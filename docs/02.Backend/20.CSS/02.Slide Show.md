---
title: Slide Show
date: 2021-03-31 16:50:12
permalink: /pages/9b6906/
categories:
  - Backend
  - CSS
tags:
...
import CitiesSlider from './slide.js';

const axios = require('axios').default;
function App() {

  const SaveImage = ()=>{
    axios.post('https://images.bigrocksports.com/img/item/thumb/06/04/0604-1195.jpg').
    ...
    // firebase.storeImage(key,'products',);
  }
  const slides = [
    {
      city: 'Paris',
